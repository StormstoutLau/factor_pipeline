        ...
        return cls(
            ...
            steps=[
                StepConfig(
                    ...
                    module_path="factor_pipeline.modules.factor_imputer",
                    class_name="HierarchicalImputer",
                    params={'strategy': 'auto'}
                ),
                StepConfig(
                    step_type=StepType.OUTLIER_DETECTION,
                    module_path="factor_pipeline.modules.factor_adaptive_winsor",
                ...
                StepConfig(
                    ...
                    module_path="factor_pipeline.modules.factor_neutralizer",
